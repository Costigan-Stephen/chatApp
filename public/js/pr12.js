...
const login = async() => {
    ...
    if (!username || username.trim() === '') {
        errorContainer.innerHTML = '<span class="error notice">Username cannot be empty!</span>';
        return;
    }

    if (username === "Admin" || username === "admin") {
        errorContainer.innerHTML = '<span class="error notice">Admin is a reserved name!</span>';
        return;
    }
